  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12" ref={formRef}>
      <div className="container mx-auto max-w-5xl px-4">
        <div className="bg-white shadow-lg rounded-lg p-8">
          ...
          <form className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="mileage" className="block text-sm font-medium text-gray-700">Car Registration</label>
                <input
                  type="text"
                  id="mileage"
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              ...
              <div>
                <label htmlFor="carReg" className="block text-sm font-medium text-gray-700">Mileage</label>
                <input
                  type="text"
                  id="carReg"
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
      ...
      />
            ...
            <img src="public\assets\WhatsApp Image 2024-10-22 at 23.16.25_8a0bdb39.jpg" alt="Uploaded Vehicle" className="mt-2 rounded-lg shadow-lg" />
